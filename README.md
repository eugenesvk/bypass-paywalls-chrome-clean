...
### Installation
 [Download and install the latest version](https://github.com/magnolia1234/bypass-paywalls-firefox-clean/releases/download/v1.6.6.6/bypass_paywalls_clean-1.6.6.6-an+fx.xpi)\
